...
// Crearea arborelui
$tree = new BinaryTree();
$tree->root = new Node("Ai des durere în picioare?");
$tree->root->left = new Node("Durerea este constantă sau apare la efort?");
$tree->root->right = new Node("Simți umflături sau inflamații în picioare?");
...
$tree->root->left->right->left->left = new Node("", "Artrită");
$tree->root->left->right->left->right = new Node("", "Tendinită");
$tree->root->left->right->right->left = new Node("", "Bursită");
$tree->root->left->right->right->right = new Node("", "Sindromul piciorului neliniștit");
...
$tree->root->right->right->left = new Node("Simți amorțeală sau furnicături în picioare?");
...
$tree->root->right->left->left->left = new Node("", "Tromboză venoasă profundă");
...
$tree->root->right->right->left->right = new Node("", "Insuficiență venoasă cronică");
$tree->root->right->right->right->left = new Node("", "Varice");
$tree->root->right->right->right->right = new Node("", "Arteriopatie periferică");
