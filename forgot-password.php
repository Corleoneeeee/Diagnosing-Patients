...
$newpassword=md5($_POST['newpassword']);
	$sql ="SELECT EmailId FROM utilizatori WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update utilizatori set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
$error="E-mail sau numărul mobil nu sunt valide";	
}
}
